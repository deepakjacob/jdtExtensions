...
import ca.jacob.quickassist.proposals.TypeCreator;

/**
 * A plug-in which provides a quick assist to provide an implementation of an
 * interface with in
 * Eclipse JDT.
 * 
 * @author Deepak Jacob
...
public class QuickAssistProcessor implements IQuickAssistProcessor {
	...
	public boolean hasAssists(IInvocationContext context) throws CoreException {
		...
		if (coveringNode != null) {
			return createClassProposal(context, coveringNode, null, null);
		}
		return false;
	}
	...
	public IJavaCompletionProposal[] getAssists(IInvocationContext context,
		...
		if (coveringNode != null) {
			...
			if (noErrorsAtLocation) {
				createClassProposal(context, coveringNode, locations, resultingCollections);
			}
	...
	/**
	 * See whether an quick assist for an implementation class is relevant in
	 * the selected context.
	 * 
	 * @param context
	 *            the quick assist context.
	 * @param node
	 *            the selected token from which the quick assist is launched.
	 * @param locations
	 *            locations where problems found in this compilation unit.
	 * @param resultingCollections
	 *            the proposals created.
	 * @return true if proposals exists else return false
	 */
	private boolean createClassProposal(IInvocationContext context, ASTNode node,
		...
		TypeCreator proposal =
		        new TypeCreator(cu,name, TypeCreator.K_CLASS, null, 6);
